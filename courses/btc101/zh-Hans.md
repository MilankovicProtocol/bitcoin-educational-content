---
name: 探索比特币之旅
goal: 探索比特币及其基本原理，包括其货币价值主张、矿机、交易和钱包。
objectives:
  - 对比特币技术拥有总体的理解
  - 了解如何购买和保护比特币
  - 对区块链技术拥有总体的理解
...
在这门课程中，我将通过25个章节来讲解比特币，以便您能够以一种简单有效的方式理解这项技术。此课程对所有人开放，探索比特币行业的各个方面：矿机、钱包、购买/销售平台等...

课程大约需要15小时。在整个学习过程中，您可使用所提供的解释性海报和额外资料。

无需具有任何特定的知识，您就可以开始学习，此课程对所有人都开放！
...
比特币是一项重要的创新，具有重大影响力的“互联网货币”。这是在技术和货币方面的一场革命，可挑战我们对货币和社会的看法。比特币是一种所谓的**中立**和**去中心化**货币，这意味着比特币不受任何实体或机构的控制。它是一项重大创新，其功能不限于货币应用。为了理解许多人所知的比特币，重要的是要明白比特币（称为BTC）即是一个计算机协议（Bitcoin），也是一个货币单位（比特币）。

该协议使用一些基础技术如密码术、网络通信和大众所知的“区块链”，而比特币单位是该协议正常运行所需的货币。在日常生活中，萨尔瓦多人或世界各地的比特币用户使用比特币货币购买和销售商品和服务，其运作依赖于比特币协议。

### 一个全面且易于理解的课程

在这门课程中，我们将讨论比特币的货币方面，包括如何购买和销售比特币、如何在数字电子钱包内安全存储以及如何将比特币用于进行交易。我们还将探讨矿机的作用，他们对于创建新的比特币和保护比特币网络至关重要。此外，我们将探索比特币的未来以及闪电网络技术如何改善比特币交易。

![image](assets/en/chapter0/4.webp)

理解比特币至关重要，比特币是一种新的货币系统，可彻底改变我们与货币的关系。想要掌控自己资金的人必须学习如何使用比特币，因为这是一个必不可少的技能。
...
在讨论货币于社会中的定义和功能（第1章）之前，我们首先从比特币的起源开始。比特币是一项相对较新的技术，于2009年推出，其是独一无二的。因此，您一开始您可能对其内容毫无理解，而这个是正常的。事实上，就像学习使用互联网或开车一样，尽管您未知道比特币的所有技术细节，您还可以使用它（接收、支付、保护你的资金）。
...
在20世纪80年代和90年代的技术进化时期中，一群人开始深刻质疑隐私和自由在数字时代的角色。后来，这些人被称为“密码朋克”，他们坚信密码学可作为一种工具，以保护个人权利免受政府和大公司的干扰。

朱利安·阿桑奇（Julian Assange）、魏代（Wei Dai）、蒂姆·梅（Tim May）和大卫·尚姆（David Chaum）等标志性人物为密码朋克的哲学和愿景做出了定义。这些思想家在一个有影响力的邮件列表中分享了他们的想法，来自世界各地的参与者在这里辩论如何使用技术来确保个人自由的提高和改善。

### 密码朋克的三大支柱文本

![image](assets/en/chapter0/2.webp)

密码朋克运动，其深厚根植于数字行动主义和密码学中，依靠几篇基本文本来表达其原则和对未来的愿景。其中，三篇著作引起了关注：

- 《密码朋克宣言》：
  由埃里克·休斯（Eric Hughes）在1993年撰写的《密码朋克宣言》宣称隐私是一项基本权利。休斯认为，实现人与人的自由交流和保持其保密性对于自由的社会至关重要。宣言指出：“我们不能指望机构、公司或其他非个人实体为我们给予隐私……我们必须自己去保护。”

- 《加密无政府主义宣言》：
  于1992年由蒂莫西·C·梅（Timothy C. May）写作，这份宣言解释了如何密码学的使用可以导致一个加密无政府主义的时代，在这个时代，政府将无力干涉到公民的私事。梅设想了一个未来，其可在无第三方干预的情况下交换信息、金钱和消息，并且无需暴露身份信息。

- 《网络空间独立宣言》：
虽然不完全属于密码朋克（cypherpunk）的产物，但这段文字反映了该运动中许多参与者的情绪。这是于1996年由约翰·佩里·巴洛（John Perry Barlow）写下的，作为对政府日益增加的互联网监管的回应。该宣言断言，网络空间是一个与现实世界不同的领域，不应受到相同法律的约束。它声明：“我们没有当选政府，我们不能被治理。
